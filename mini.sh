...
# Clonar repositorio
echo -e "\033[1;35mClonando el repositorio de SakunaBot-MD...\033[0m"
git clone https://github.com/ale78292231-collab/NexoBot.git
...
» Alex Lp, Carlos rv
✰ GitHub:
» https://github.com/ale78292231-collab
